...
def EMAIL_RECIPIENTS = "gilles.boussengui@gmail.com"
	...
	try {
        ...
        stage('Sonarqube Analysis') {
			withSonarQubeEnv('SonarQubeLocalServer') {
				sh " mvn sonar:sonar -Dintegration-tests.skip=true -Dmaven.test.failure.ignore=true -Dsonar.host.url=http://sonarqube:9000"
            }
